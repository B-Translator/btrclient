...
function rrssb_get_buttons($options = array()) {
  ...
  for ($i = 0; $i < sizeof($buttons); $i++) {
    $output .= _get_button_code($buttons[$i], $options);
  }
  $output .= '</ul></div>';
...
function _get_button_code($button, $options) {
  ...
  switch ($button) {
    ...
    case 'facebook':
      ...
      $html .=  '<a href="https://www.facebook.com/sharer/sharer.php?u=' . $options['url'] . '" class="popup">';
      $html .= '
            <span class="rrssb-icon">
    ...
    case 'googleplus':
      ...
      $html .= '<a href="https://plus.google.com/share?hl=' . $options['lng'] .'&amp;url=' . $options['title'] . '%20' . $options['url'] . '" class="popup">';
      $html .= '
            <span class="rrssb-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
    ...
    case 'pinterest':
      ...
      $html .= '<a href="http://pinterest.com/pin/create/button/?url=' . $options['url'] . '&amp;media=' . $options['pinterest_media'] .'&amp;description=' . $options['title'] . '" class="popup">';
      $html .= '
            <span class="rrssb-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
    ...
    case 'tumblr':
      ...
      $html .= '<a href="http://tumblr.com/share?s=&amp;v=3&t='. $options['title'] . '&amp;u=' . $options['url'] . '">';
      $html .= '
            <span class="rrssb-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
    ...
    case 'reddit':
      ...
      $html .= '<a href="http://www.reddit.com/submit?url=' . $options['url'] . '">';
      $html .= '
            <span class="rrssb-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
      ...
      // hackernews
    case 'hackernews':
      $html = '<li class="rrssb-hackernews">';
      $html .= '<a href="https://news.ycombinator.com/submitlink?u=' . $options['url'] . '&t=' . $options['title'] . '&text=' . $options['title'] . '" class="popup">';
      $html .= '
            <span class="rrssb-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
    ...
    case 'youtube':
      ...
      $html .= '<a href="https://www.youtube.com/user/' . $options['youtube_username'] . '">';
      $html .= '
            <span class="rrssb-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
      ...
      // pocket
    case 'pocket':
      $html = '<li class="rrssb-pocket">';
      $html .= '<a href="https://getpocket.com/save?url=' . $options['url'] . '">';
      $html .= '
            <span class="rrssb-icon">
    ...
    case 'github':
      ...
      $html .= '<a href="https://github.com/'. $options['github_username'] . '">';
      $html .= '
            <span class="rrssb-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">
      ...
      // vk
    case 'vk':
      $html = '<li class="rrssb-vk">';
      $html .= '<a href="http://vk.com/share.php?url=' . $options['url'] . '" class="popup">';
      $html .= '
            <span class="rrssb-icon">
